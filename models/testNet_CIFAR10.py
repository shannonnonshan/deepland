...
def main():
    parser = argparse.ArgumentParser(description="Verify best checkpoint for CIFAR-10")
    parser.add_argument("--checkpoint", type=str, default="outputs_final/cifar10/best_checkpoint.pth")
    ...
    model = NetBT2(n_class=10).to(device)
